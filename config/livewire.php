...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'middleware' => 'throttle:300,1',                                 // Example: 'throttle:5,1'            | Default: 'throttle:60,1'
    ...
    */
    ...
    'payload' => [
        'max_size' => null,   // Disabled limit - fixed PayloadTooLargeException on mobile uploads by allowing larger payloads (base64 images)
