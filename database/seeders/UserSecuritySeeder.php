...
class UserSecuritySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($user) {
            $user->update([
                'password' => \Illuminate\Support\Facades\Hash::make('ProcGesto?335'),
                ...
                'email_verified_at' => '2026-02-26 18:18:45',
                'is_active' => true,
                'membership_status' => \App\Enums\MembershipStatus::Active,
            ]);

            $this->command->info('Bezpečnostní nastavení pro nejedlymi@gmail.com byla AKTUALIZOVÁNA a heslo nastaveno.');
        } else {
