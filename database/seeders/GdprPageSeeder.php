                ...
                'content' => [
                    'cs' => [
                        ...
                        [
                            'type' => 'rich_text',
                            'data' => [
                                'content' => '<h3>Právní informace a správce údajů</h3><p>Oficiálním správcem vašich osobních údajů pro naše mužské týmy je:</p><p><strong>Tomáš Spanilý</strong> – vedoucí týmu<br>Praha 9<br>Mobil: +420 602 285 447<br>E-mail: <a href="javascript:void(0)" data-protected-email="c3BhbmlseUBwcm8tbmVtby5jeg==">spanily [zavináč] pro-nemo.cz</a></p><h3>Pověřenec pro GDPR</h3><p><strong>Michal Nejedlý</strong><br>E-mail: <a href="javascript:void(0)" data-protected-email="bmVqZWRseW1pQGdtYWlsLmNvbQ==">nejedlymi [zavináč] gmail.com</a></p><p>Podrobná pravidla celého oddílu najdete v <a href="https://www.basketkbely.cz/" target="_blank">oficiálním dokumentu na webu TJ Sokol Kbely Basketball</a>.</p><h3>Osobní údaje</h3><p>Zpracováváme pouze údaje nezbytné pro fungování týmu, organizaci zápasů a tréninků (jméno, e-mail, telefon, docházka). Údaje uchováváme po dobu vašeho aktivního členství v týmu. Máte právo na přístup k údajům, jejich opravu či výmaz.</p><h3>Soubory cookies</h3><p>Tento web používá pouze nezbytné technické cookies pro zajištění funkčnosti (např. přihlášení do členské sekce). Nepoužíváme žádné sledovací ani marketingové cookies třetích stran.</p>',
                            ],
                        ],
                    ],
                    'en' => [
