        ...
        return $table
            ->columns([
                ...
                TextColumn::make('status')
                    ...
                    ->formatStateUsing(fn (string $state): string => __("admin.navigation.resources.feedback_report.status.{$state}"))
            ...
            ->filters([
                SelectFilter::make('type')
                    ->options([
                        'bug' => __('admin.navigation.resources.feedback_report.type.bug'),
                        'idea' => __('admin.navigation.resources.feedback_report.type.idea'),
                        'feedback' => __('admin.navigation.resources.feedback_report.type.feedback'),
                    ])
                    ->label(__('admin.navigation.resources.feedback_report.fields.type')),
                SelectFilter::make('severity')
                    ->options([
                        'low' => __('admin.navigation.resources.feedback_report.severity.low'),
                        'medium' => __('admin.navigation.resources.feedback_report.severity.medium'),
                        'high' => __('admin.navigation.resources.feedback_report.severity.high'),
                    ])
                    ->label(__('admin.navigation.resources.feedback_report.fields.severity')),
