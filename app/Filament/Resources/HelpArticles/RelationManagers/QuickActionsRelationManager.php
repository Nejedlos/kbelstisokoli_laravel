                ...
                Grid::make(2)
                    ->components([
                        ...
                        TextInput::make('title.en')
                            ->label(__('admin.resources.help_quick_action.fields.title_en'))
                            ->required(),
                    ]),
                Grid::make(2)
                    ->components([
                        Textarea::make('description.cs')
                            ->label(__('admin.resources.help_quick_action.fields.description_cs'))
                            ->rows(2)
                            ->default(null),
                        Textarea::make('description.en')
                            ->label(__('admin.resources.help_quick_action.fields.description_en'))
                            ->rows(2)
                            ->default(null),
                    ]),
                Grid::make(3)
                    ->components([
                        TextInput::make('url')
                            ->label(__('admin.resources.help_quick_action.fields.url'))
                        ...
                        TextInput::make('sort_order')
                            ->label(__('admin.resources.help_quick_action.fields.sort_order'))
                            ->numeric()
                            ->default(0)
                            ->required(),
                    ]),
