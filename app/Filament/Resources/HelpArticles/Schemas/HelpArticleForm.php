        ...
        return $schema
            ->components([
                ...
                Tabs::make('Article Content')
                    ->tabs([
                        Tabs\Tab::make(__('admin.resources.help_article.tabs.content'))
                                ...
                                Grid::make(2)
                                    ->components([
                                        Textarea::make('excerpt.cs')
                                            ->label(__('admin.resources.help_article.fields.excerpt_cs'))
                                            ->rows(2)
                                            ->default(null),
                                        Textarea::make('excerpt.en')
                                            ->label(__('admin.resources.help_article.fields.excerpt_en'))
                                            ->rows(2)
                                            ->default(null),
                                    ]),

                                MarkdownEditor::make('content.cs')
                                    ->label(__('admin.resources.help_article.fields.content_cs'))
                                    ->required()
                                    ->columnSpanFull(),
                                MarkdownEditor::make('content.en')
                                    ->label(__('admin.resources.help_article.fields.content_en'))
                                    ->required()
                                    ->columnSpanFull(),
                            ]),

                        Tabs\Tab::make(__('admin.resources.help_article.tabs.settings'))
                            ...
                            ->components([
                                Grid::make(2)
                                    ->components([
                                        Select::make('category_id')
                                            ...
                                            ->required(),
                                        TextInput::make('slug')
                                            ->label(__('admin.resources.help_article.fields.slug'))
                                            ->required()
                                ...
                                TextInput::make('search_keywords')
                                    ->label(__('admin.resources.help_article.fields.search_keywords'))
                        ...
                        Tabs\Tab::make(__('admin.resources.help_article.tabs.metadata'))
