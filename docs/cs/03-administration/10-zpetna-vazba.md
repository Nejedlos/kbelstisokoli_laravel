...
# Moderní Bug Report / Feedback Systém (Widget)
...
- **CORS u screenshotu:** Pokud se na stránce nachází obrázky z cizích domén bez správné CORS hlavičke, nemusí se na screenshotu zobrazit.
