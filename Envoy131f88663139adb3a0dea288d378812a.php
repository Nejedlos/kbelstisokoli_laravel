...
<?php $__container->startTask('setup', ['on' => 'web']); ?>
    ...
    if [ ! -z "<?php echo $public_path ?? ''; ?>" ] && [ "<?php echo $public_path; ?>" != "<?php echo $path; ?>/public" ]; then
...
EOF
    <?php echo $php; ?> patch_entrypoints.php "<?php echo $path; ?>" "<?php echo $public_path ?? $path . '/public'; ?>" "$DEST"
...
EOF
        <?php echo $php; ?> patch_entrypoints.php "<?php echo $path; ?>" "<?php echo $public_path ?? $path . '/public'; ?>" "<?php echo $public_path; ?>/index.php"
        rm patch_entrypoints.php
        echo "✅ Entry points patched."
    fi
