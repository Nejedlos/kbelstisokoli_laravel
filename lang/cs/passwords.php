...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Následující hlášky se používají při procesu obnovy hesla.
    |
    */

    'reset' => 'Vaše heslo bylo úspěšně změněno. Teď se můžete přihlásit.',
    'sent' => 'Odkaz pro obnovu hesla jsme vám odeslali e-mailem. Podívejte se do schránky (i do spamu).',
