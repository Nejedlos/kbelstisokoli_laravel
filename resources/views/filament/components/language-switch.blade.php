<div class="flex items-center gap-1 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg text-[10px] font-black tracking-widest shadow-sm border border-gray-200 dark:border-gray-700">
