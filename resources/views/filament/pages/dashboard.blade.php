    ...
    <div class="space-y-8 pb-12">
        ...
        <div class="relative overflow-hidden rounded-[2rem] bg-gray-900 shadow-2xl dark:bg-black">
            ...
            <div class="relative flex flex-col lg:flex-row items-center gap-8 p-6 sm:p-10 md:p-12">
                <div class="flex-1 space-y-6 text-center lg:text-left">
                    <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-primary-400 backdrop-blur-md">
                    ...
                    <p class="max-w-xl text-base sm:text-lg text-gray-400 leading-relaxed mx-auto lg:mx-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div class="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="sm:col-span-2 relative overflow-hidden rounded-3xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-white/5 shadow-sm p-6 sm:p-8 flex flex-col md:flex-row items-center gap-8">
                     <div class="flex-1 space-y-4 w-full">
                        ...
                        <div class="text-3xl sm:text-4xl font-black text-gray-900 dark:text-white tracking-tighter">
                ...
                <div class="rounded-3xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-white/5 shadow-sm p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-3xl font-black text-gray-900 dark:text-white">{{ $stats['teams'] }}</span>
                    </div>
                    <h4 class="font-black text-gray-900 dark:text-white uppercase tracking-tight text-xs sm:text-sm">{{ __('admin/dashboard.kpi.teams_total') }}</h4>
                    <p class="text-[11px] sm:text-xs text-gray-500 mt-1">Aktuálně registrované týmy</p>
                </div>

                {{-- Players Card --}}
                <div class="rounded-3xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-white/5 shadow-sm p-5 sm:p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-3xl font-black text-gray-900 dark:text-white">{{ $stats['players'] }}</span>
                    </div>
                    <h4 class="font-black text-gray-900 dark:text-white uppercase tracking-tight text-xs sm:text-sm">{{ __('admin/dashboard.kpi.players_total') }}</h4>
                ...
                <div class="rounded-3xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-white/5 shadow-sm p-5 sm:p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-3xl font-black text-gray-900 dark:text-white">{{ $stats['leads_pending'] }}</span>
                    </div>
                    <h4 class="font-black text-gray-900 dark:text-white uppercase tracking-tight text-xs sm:text-sm">{{ __('admin/dashboard.kpi.leads_total') }}</h4>
                ...
                <div class="rounded-3xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-white/5 shadow-sm p-5 sm:p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-3xl font-black text-gray-900 dark:text-white">{{ $stats['posts_active'] }}</span>
                    </div>
                    <h4 class="font-black text-gray-900 dark:text-white uppercase tracking-tight text-xs sm:text-sm">{{ __('admin/dashboard.kpi.posts_total') }}</h4>
                    <p class="text-[11px] sm:text-xs text-gray-500 mt-1">{{ __('admin/dashboard.kpi.posts_active_desc', ['count' => $stats['posts_active']]) }}</p>
                </div>

                {{-- System Health Card --}}
                <div class="sm:col-span-2 rounded-3xl bg-gray-50 dark:bg-white/5 border border-dashed border-gray-200 dark:border-white/10 p-6 sm:p-8">
                     <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h4 class="text-base sm:text-lg font-black text-gray-900 dark:text-white uppercase tracking-tight">{{ __('admin/dashboard.system.title') }}</h4>
            ...
            <div class="md:col-span-4 space-y-6">
                ...
                <div class="rounded-3xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden">
                    <div class="p-5 sm:p-6 border-b border-gray-50 dark:border-white/5 bg-gray-50/50 dark:bg-white/5 flex items-center justify-between">
                        ...
                        @forelse($recentActivity as $log)
                            <div class="flex gap-4 group">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="text-xs font-bold text-gray-900 dark:text-white leading-snug group-hover:text-primary-600 transition-colors">
                                        {{ $log->action }}: {{ $log->subject }}
                                    </div>
                                    @if($log->details)
                                        <div class="text-[11px] sm:text-xs text-gray-400 dark:text-gray-500 italic mt-0.5">{{ $log->details }}</div>
                                    @endif
