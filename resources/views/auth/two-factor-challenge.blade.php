...
<div x-data="{ recovery: false }">
    <!-- Header -->
    <x-auth-header title="Ověření přístupu" subtitle="Zadejte kód z vaší aplikace" icon="fa-shield-check" />
    ...
    <div class="glass-card">
        <form method="POST" action="{{ route('two-factor.login') }}" class="space-y-8" novalidate>
            ...
            <div class="space-y-4" x-show="!recovery">
                <label for="code" class="fi-fo-field-label block text-center">6místný ověřovací kód</label>
            ...
            <div class="space-y-4" x-show="recovery" x-cloak>
                <label for="recovery_code" class="fi-fo-field-label block text-center">Záchranný kód</label>
                <div class="relative group/input">
            ...
            <button type="submit" class="fi-btn-color-primary w-full py-5 rounded-2xl text-base group/btn">
