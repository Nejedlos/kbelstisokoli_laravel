...
@section('content')
    <x-page-header
        ...
        :subtitle="($pool->event_date ? ($pool->event_date->day === 1 && $pool->event_date->month === 1 ? $pool->event_date->format(__('general.year_format')) : $pool->event_date->format(__('general.date_format'))) . ($pool->getTranslation('description', app()->getLocale()) ? ' • ' : '') : '') . brand_text($pool->getTranslation('description', app()->getLocale()))"
