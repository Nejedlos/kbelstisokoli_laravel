            ...
            <div class="flex items-center gap-2 sm:gap-4 md:gap-5 flex-1 justify-end">
                ...
                <div class="relative" x-data="{ userOpen: false }">
                    ...
                    <div x-show="userOpen" @click.away="userOpen = false"
                        ...
                        <a href="{{ route('member.profile.edit') }}" class="block px-4 py-2 text-sm hover:bg-slate-50 transition-colors font-bold">
                            <i class="fa-light fa-user mr-2"></i> {{ __('nav.my_profile') }}
                        </a>
                        ...
                        @endif
                        <a href="{{ route('public.home') }}" class="block px-4 py-2 text-sm hover:bg-slate-50 transition-colors font-bold">
                            <i class="fa-light fa-globe mr-2"></i> {{ __('nav.public_web') }}
                        </a>
                        <hr class="my-2 border-slate-100">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="block w-full text-left px-4 py-2 text-sm text-danger-600 hover:bg-danger-50 transition-colors font-bold">
                                <i class="fa-light fa-right-from-bracket mr-2"></i> {{ __('nav.logout') }}
                            </button>
                        </form>
                    </div>
                </div>
